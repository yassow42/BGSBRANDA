...
class PergoleActivity : AppCompatActivity() {
    ...
    private fun siparisEkle(musteriKey: String?) {
        ...
        foto1Pergole.setOnClickListener {
            var intent = Intent()
        ...
        foto2Pergole.setOnClickListener {
            var intent = Intent()
        ...
        foto3Pergole.setOnClickListener {
            var intent = Intent()
       ...
       foto4Pergole.setOnClickListener {
            var intent = Intent()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RESIM_SEC1 && resultCode == AppCompatActivity.RESULT_OK && data!!.data != null) {
            ...
            Picasso.get().load(profilPhotoUri1).resize(size, size).into(foto1Pergole)
        ...
        if (requestCode == RESIM_SEC2 && resultCode == AppCompatActivity.RESULT_OK && data!!.data != null) {
            ...
            Picasso.get().load(profilPhotoUri2).resize(size, size).into(foto2Pergole)
        ...
        if (requestCode == RESIM_SEC3 && resultCode == AppCompatActivity.RESULT_OK && data!!.data != null) {
            ...
            Picasso.get().load(profilPhotoUri3).resize(size, size).into(foto3Pergole)
        ...
        if (requestCode == RESIM_SEC4 && resultCode == AppCompatActivity.RESULT_OK && data!!.data != null) {
            ...
            Picasso.get().load(profilPhotoUri4).resize(size, size).into(foto4Pergole)
